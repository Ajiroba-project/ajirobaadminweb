  ...
  const salesDataMain = [
    {
      ...
      amount: transInfo?.data?.regular_deals?.today?.today_sales || "N45,823",
    ...
    },
    {
      ...
      amount: transInfo?.data?.regular_deals?.this_week?.this_week_sales || "N45,823",
    ...
    },
    {
      ...
      amount: transInfo?.data?.regular_deals?.this_month?.this_month_sales || "N45,823",
